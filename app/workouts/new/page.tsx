...
import { useWorkouts, type Exercise } from "@/components/workout-provider"
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <div className="space-y-1">
              ...
              <CardDescription>Add the exercises for this workout</CardDescription>
            </div>
